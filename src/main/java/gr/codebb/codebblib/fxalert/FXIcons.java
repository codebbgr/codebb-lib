...
/**
 * Provides access to the built-in JavaFX icons. NOTE: If modena.css changes, this class will need
 * to.
 */
public class FXIcons {

  /**
   * Returns a Label with the style of an Alert with type INFORMATION's icon.
   *
  ...
  /**
   * Returns a Label with the style of an Alert with type CONFIRMATION's icon.
   *
  ...
  /**
   * Returns a Label with the style of an Alert with type ERROR's icon.
   *
  ...
  /**
   * Returns a Label with the style of an Alert with type WARNING's icon.
   *
