...
/**
 * Builder-style class for creating temporary "flash" notifications in the lower-right corner of the
 * user's screen.
 */
public class FlashBuilder {
  ...
  /**
   * Instructs the flash notification to use the icon from the AlertType.INFORMATION Alert
   *
  ...
  /**
   * Instructs the flash notification to use the icon from the AlertType.ERROR Alert
   *
   * @return The FlashBuilder
   */
  ...
  /**
   * Instructs the flash notification to use the icon from the AlertType.WARNING Alert
   *
   * @return The FlashBuilder
   */
  ...
  /**
   * Instructs the flash notification to use the icon from the AlertType.CONFIRMATION Alert
   *
   * @return The FlashBuilder
   */
  ...
  /**
   * Sets the Node as the header section for the flash notification.
   *
  ...
  /**
   * Sets the Node as the content section of the flash notification.
   *
  ...
  /**
   * Sets the content section of the flash notification.
   *
  ...
  /**
   * Sets an Image as the graphic (icon) for the flash notification.
   *
  ...
  /**
   * Sets a Node as the graphic (icon) for the flash notification.
   *
  ...
  /**
   * Set the size of the flash notification with the given width and height.
   *
  ...
  /**
   * Allows setting the JavaFX style of the pane (GridPane) used to display the notification.
   *
  ...
  /**
   * Shows the "flash" notification for a brief period of time in the lower-right corner of the
   * user's active screen. The Flash Alert will cause a new taskbar icon to be created unless the
   * {@code withInitOwner()} methods has been previously called.
   */
  public void show() {
