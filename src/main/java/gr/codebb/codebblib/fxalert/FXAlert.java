package gr.codebb.codebblib.fxalert;
...
/**
 * Class for easily building JavaFX Alerts. API is available as static methods of {@code FXAlert}.
 */
public class FXAlert {
  ...
  /**
   * Shows an Alert of type "INFORMATION" with specified title, header, and content texts.
   *
  ...
  /**
   * Shows an Alert of type "INFORMATION" with specified header and content texts.
   *
   * @param header Alert header text
   * @param content Alert content text
   */
  ...
  /**
   * Shows an Alert of type "CONFIRMATION" with specified title, header, and content texts.
   *
   * @param title Alert title text
   * @param header Alert header text
   * @param content Alert content text
  ...
  /**
   * Shows an Alert of type "CONFIRMATION" with specified header and content texts.
   *
   * @param header Alert header text
   * @param content Alert content text
   * @return Result of {@code alert.showAndWait()}
  ...
  /**
   * Shows an Alert of type "CONFIRMATION" with specified content text.
   *
   * @param content Alert content text
   * @return Result of {@code alert.showAndWait()}
   */
  ...
  /**
   * Shows an Alert of type "CONFIRMATION" with specified text. Returns true if and only if user
   * clicks "Ok".
   *
   * @param header Alert header text
   * @param content Alert content text
  ...
  /**
   * Shows an Alert of type "ERROR" with specified title, header, and content texts.
   *
   * @param title Alert title text
   * @param header Alert header text
   * @param content Alert content text
  ...
  /**
   * Shows an Alert of type "ERROR" with specified header and content texts.
   *
   * @param header Alert header text
   * @param content Alert content text
   */
  ...
  /**
   * Shows an Alert of type "ERROR" with specified content text.
   *
   * @param content Alert content text
   */
  ...
  /**
   * Shows an Alert of type "WARNING" with specified title, header, and content texts.
   *
   * @param title Alert title text
   * @param header Alert header text
   * @param content Alert content text
  ...
  /**
   * Shows an Alert of type "WARNING" with specified header and content texts.
   *
   * @param header Alert header text
   * @param content Alert content text
   */
  ...
  /**
   * Shows an Alert of type "WARNING" with specified content text.
   *
   * @param content Alert content text
   */
  ...
  /**
   * Prepares a JavaFX Alert suitable for displaying a {@code java.lang.Exception} or {@code
  ...
  public static AlertBuilder exception(Throwable e) {
    return new AlertBuilder(e, EMPTY_STRING, EMPTY_STRING, "The exception stacktrace was:");
  }

  /**
   * Shows an Alert for displaying an {@code Exception} with specified title, header, and content
   * texts.
   *
   * @param e Throwable
   * @param title Alert title text
  ...
  /**
   * Shows an Alert for displaying an {@code Exception} with specified header and content texts.
   *
   * @param e Throwable
   * @param header Alert header text
   * @param content Alert content text
  ...
  /**
   * Shows an Alert for displaying an {@code Exception} with specified content text.
   *
   * @param e Throwable
   * @param content Alert content text
   */
  ...
  /**
   * Start constructing a "flash" alert. (An alert temporarily displayed at the bottom-right of the
   * active screen)
   *
  ...
  /**
   * Start constructing a "flash" alert at the bottom-right of the active screen. Sets the initOwner
   * of the flash alert, causing no additional task bar icons to be created. Prefer {@code
   * flash(Window initOwner} to {@code flash()}
   *
  ...
  /**
   * Adds an title bar icon to be used for all FXAlert methods. Once enabled, set to null to disable
   * further Alert's from inheriting this icon.
   *
