...
public interface IDialogBuilder<T> {
  ...
  /**
   * Adds the image at the given path as the Alert or Dialog's Graphic
   *
  ...
  /**
   * Clears existing ButtonTypes, then adds them to the Alert/Dialog
   *
  ...
  /**
   * Positions the Alert or Dialog at the given X and Y coordinates
   *
  ...
  /**
   * Shows a blocking alert and awaits the result. The Optional result could be
   * String/Double/Integer in the case of an Input dialog, or a ButtonType in the case of an Alert
   * or Dialog that doesn't support input.
   *
