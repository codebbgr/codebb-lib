 ...
 */
package gr.codebb.codebblib.fxcontrols.skin;
...
public class TextFieldWithButtonSkin extends TextFieldSkin {
  ...
  private InvalidationListener rightButtonVisibleChanged =
      observable -> onRightButtonVisibilityChanged();
  ...
  private static final CssMetaData<TextField, Boolean> RIGHT_BUTTON_VISIBLE_META_DATA =
      new CssMetaData<>(RIGHT_BUTTON_VISIBLE_PROPERTY_NAME, BooleanConverter.getInstance(), true) {
  ...
  private BooleanProperty rightButtonVisible =
      new SimpleStyleableBooleanProperty(RIGHT_BUTTON_VISIBLE_META_DATA, true);
