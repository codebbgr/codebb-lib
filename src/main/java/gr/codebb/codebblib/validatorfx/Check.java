...
public class Check {
  ...
  /**
   * Sets this check to be immediately evaluated if one of its dependencies changes. This method
   * must be called last.
   */
  ...
  /**
   * Evaluate all dependencies and apply decorations of this check. You should not normally need to
