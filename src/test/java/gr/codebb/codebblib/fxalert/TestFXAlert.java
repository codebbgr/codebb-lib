...
/** Runnable test class for FXAlert Displays a series of JavaFX Alerts */
  ...
  public void start(Stage primaryStage) {
    ...
    Optional<ButtonType> result2 =
        FXAlert.confirm()
            ...
            .withText("Yes or no?")
            .showAndWait();
    result2.ifPresent(e -> FXAlert.info().withText("User clicked " + e.getText()).show());
